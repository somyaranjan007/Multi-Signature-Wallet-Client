        ...
        <nav className='flex justify-row justify-between m-4 relative '>
            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex align-center"
                    ...
                    <div className="group relative inline-flex items-center justify-start inline-block px-4 py-2 overflow-hidden font-medium transition-all bg-blue-600 rounded-lg hover:bg-white cursor-pointer">
                        <span className="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-blue-600 cursor-pointer">Connect Wallet  <ExpandMoreIcon className='w-5' /></span>
                    </div>
